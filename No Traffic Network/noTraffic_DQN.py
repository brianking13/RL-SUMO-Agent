...
def build_agent(model, actions):
    ...
    policy = LinearAnnealedPolicy(EpsGreedyQPolicy(), attr='eps', value_max=1, value_min=.01, value_test=.00001,
                                  nb_steps=800*20)
...
history = dqn.fit(env, nb_steps =800*500, visualize=False, verbose =1)
